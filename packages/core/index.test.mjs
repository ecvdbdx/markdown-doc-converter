...
const commentsArray = [{ text: 'This is a comment', line: 5}, { text: 'This is a second comment', line: 10}]

const expectedMarkdown = '# Documentation\n\n  > This is a comment\n\n_line 5_\n\n---\n\n\n> This is a second comment\n\n_line 10_\n\n---\n\n'
...
describe('Create Markdown from comments', () => {
  it('correctly generates markdown', () => {
    assert.deepEqual(createMarkdownFromComments(commentsArray), expectedMarkdown)
  })
})